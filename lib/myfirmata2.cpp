...
// derived from the arduino Firmata code but modified to waotk across
// a socket or serial connection

// note we'll need a Stream class too
//
//******************************************************************************
//* Includes
//******************************************************************************
...
#include "myStream.h"
// stream needs  int write(int) , int read(void) and int availlable(void)
// we also need Serial.begin
// Serial is a stream
//
#include "myFirmata.h"
