...
while True:
    ...
    pi.i2c_write_byte_data(handle, 0x41, 0x51)
    n,vx1 = pi.i2c_read_device(handle,16)
    pi.i2c_write_byte_data(handle, 0x41, 0x52)
    n,vx2 = pi.i2c_read_device(handle,16)

    print("  \033[30m"),
    print("  \033[47m"),


    print("\033[6;3H Data from Unit 8")
