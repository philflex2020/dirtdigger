...
//void MirfReceive(void);

void loop() {
  // put your main code here, to run repeatedly:
  executionTimeStart = micros();
  //MirfReceive();
  executionTimeMirf = micros();
  //Serial.print("m time ");
  //Serial.println(executionTimeMirf - executionTimeStart);
...
byte mreadBuffer[32];
byte mwriteBuffer[32];

//void MirfReceive() {
//  if(!Mirf.isSending() && Mirf.dataReady()){ // read data
//    Mirf.getData((byte *)&mreadBuffer);
//    Mirf.setTADDR((byte *)"clie1");
//    Mirf.send((byte *)mwriteBuffer);
//  }
//}
